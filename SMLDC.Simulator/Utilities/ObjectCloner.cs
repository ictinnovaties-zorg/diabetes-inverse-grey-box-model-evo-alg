...
namespace System
{
    // Class copied from: https://stackoverflow.com/questions/129389/how-do-you-do-a-deep-copy-of-an-object-in-net/11308879#11308879
    // uses MemberwiseClone() instead of BinaryFormatter which requires serializable classes, thus this is ~3 times faster
    ...
    namespace ArrayExtensions
    {
        ...
        internal class ArrayTraverse
        {
            ...
            public ArrayTraverse(Array array)
            {
                ...
                for (int i = 0; i < array.Rank; ++i) maxLengths[i] = array.GetLength(i) - 1;
